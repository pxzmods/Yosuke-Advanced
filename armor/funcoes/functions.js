...
const ceemde = JSON.parse(fs.readFileSync('./dados/dados_salvos/data/totalcmd.json'));
...
const banner2 = cfonts.render(('Canal: https://www.youtube.com/@PxzModsConteudosOficial'), {
font: 'console',
align: 'center',
gradient: [`blue`,`red`]
});
 
const banner3 = cfonts.render((`YOSUKE|3.6`), {
font: 'block',             
align: 'center',   
gradient: [`blue`,`red`],     
...
module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, banner2, temporizador, color, recognize, bgcolor, isFiltered, addFilter, banner3, chyt, getExtension, convertSticker, nit, getpc, supre, FormData }
